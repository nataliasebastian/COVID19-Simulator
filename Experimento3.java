 ...
 * @version 5 (Mayo 2021)
 */
public class Experimento3 extends World
{
    ...
    */
    ...
    private void preparar()
    {
        ...
        /*grafs[0] = new GraficadorArea(null, COLOR_LINEAS[0], 1,4);
        grafs[1] = new GraficadorColumna(null, COLOR_LINEAS[1], 5,2);
        grafs[2] = new GraficadorBarra(null, COLOR_LINEAS[2], 1,6);
        */
        for (int i=0; i<3; i++){
            espacios[i]=new Espacio (getWidth()/3, getHeight(), COLOR_LINEAS[i], COLOR_FONDOS[i]);
            espacios[i].getGraficador().setImage(espacios[i].getImagen());
